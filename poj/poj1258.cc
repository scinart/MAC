// Time-stamp: <2014-08-04 09:40:00 scinart>
// created at 2014-08-04 09:17:54
// poj1258.cc
...
int main()
{
    ...
    REP_1(i,n)
    {
        REP_1(j,n)
        {
            ...
            if(i<j)
            {
                edges.push_back(PTTT<int>(i,j,an));
            }
        }
    }
    ...
    EACH(it,edges)
    {
        if(DSET::TEST(it->first,it->second)==false)
        {
            ans+=it->third;
