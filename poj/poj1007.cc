//
// Time-stamp: <2014-07-21 11:16:59 scinart>
...
int func2(const pair<string,int>& a, const pair<string, int>& b)
{
...
int main()
{
    ...
    REP(i,m)
    {
        string str;cin>>str;
        int j = func(str);
        s.push_back(pair<string,int>(str,j));
    }
    stable_sort(ALL(s), func2);
    EACH(it,s)cout<<it->first<<'\n';
    return 0;
}
