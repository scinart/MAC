// Time-stamp: <2014-08-06 14:12:47 scinart>
// created at 2014-08-06 14:04:45
// poj3468.cc
...
public:
    ...
    Valtype query(LL l,LL r)
    {
        return query_aid(query_head, l,r);
    }
    void update(LL l,LL r,const Marktype& mark)
    {
...
private:
    ...
    Valtype query_aid(LL which_node, LL l,LL r)
    {
        pushDown(which_node);//necessary.
        LL lbound = L[which_node];
        LL rbound = R[which_node];
