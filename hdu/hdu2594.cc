// Time-stamp: <2014-07-27 02:21:47 scinart>
// created at 2014-07-27 01:32:32
// hdu2594.cc
...
int main()
{
    ...
    while(cin>>s2>>s1)
    {
        ...
        int ans=0;
        RMQ_Init(lcp,n);
        for(int i=mid+1,j=mid-1; i<n && j>=0; i++,j--)
        {
            if(i-mid==this_RMQ(rnk[mid+1], rnk[j]))
            {
                ans=i-mid;
            }
        }
