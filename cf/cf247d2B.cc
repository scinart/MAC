// Time-stamp: <2014-07-30 21:42:06 scinart>
// created at 2014-07-30 21:37:32
// cf2472B.cc
...
int main()
{
    ...
    {
        int happiness=0;
        happiness+=hap(v[0],v[1]);
        happiness+=hap(v[2],v[3]);
        happiness+=hap(v[1],v[2]);
        happiness+=hap(v[3],v[4]);
        happiness+=hap(v[2],v[3]);
        happiness+=hap(v[3],v[4]);
        checkmax(ans,happiness);
